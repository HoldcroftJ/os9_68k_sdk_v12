...
#                                                                           # 
#############################################################################
# Customize your preferred message when a target processor is not installed #
#############################################################################
UNINSTALLED		=	$(ECHO) "* NOTICE -- unsupported/uninstalled target:"

# Installed target processor MAKE targets follow:
