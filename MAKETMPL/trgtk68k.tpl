...
# 05 99/07/06 Added CPUDIR MACRO                                        mgh #
# 06 99/07/07 Removed superfluous -i option from MWOS_CSLLIBS (CF2653)  ajk #
# 08 00/01/24 Moved ISP macros to isp.tpl                               rds #
# 09 00/08/26 Change unix.l to use baslib macro to match other 68k tpls mgh #
#             $$                    <RELEASE_INFO>                     $$   #
#############################################################################
#	make template file for all hosts OS-9/68000 target 						#
#############################################################################
...
MWOS_LDIR       =   k68k                # Lower case directory name (Linkers)
MWOS_IDIR       =   RELS/$(MWOS_LDIR)
MWOS_RDIR       =   RELS/$(MWOS_LDIR)
MWOS_OSDIR		=	$(MWOS)/OS9
MWOS_ODIR		=	$(MWOS_OSDIR)/68000/CMDS

MWOS_DDIR		=	$(MWOS)/SRC/DEFS
MWOS_CDEF		=	$(TOOLSET)/SRC/DEFS

MWOS_DFTDEF		=	$(MWOS_OSDIR)/68000/DEFS
MWOS_OSDDIR		=	$(MWOS_OSDIR)/SRC/DEFS

MWOS_DFTLIB		=	$(MWOS_OSDIR)/68000/LIB
MWOS_DFTCLIB	=	$(TOOLSET)/OS9/68000/LIB

MWOS_BASLIB		=	$(MWOS_OSDIR)/68000/LIB
MWOS_BASCLIB	=	$(TOOLSET)/OS9/68000/LIB

MWOS_LIBDIR		=	$(MWOS_OSDIR)/68000/LIB
MWOS_CLIBDIR	=	$(TOOLSET)/OS9/68000/LIB
...
# Lint Options
LINTPARMS		=	-d_UCC -dANSI_EXT -d_OSK -d_MPF68K -d_FPF881 -d_BIG_END
