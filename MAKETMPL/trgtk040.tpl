...
# 05 99/05/12 Changed lib references from MWOS_LIBDIR to MWOS_BASLIB   mgh  #
...
#             $$                    <RELEASE_INFO>                     $$   #
#############################################################################
#	make template file for all hosts OS-9/68040 target 						#
#############################################################################
...
MWOS_LDIR       =   k040                # Lower case directory name (Linkers)
MWOS_IDIR		=	RELS/k68k
MWOS_RDIR		=	RELS/k040
MWOS_OSDIR		=	$(MWOS)/OS9
MWOS_ODIR		=	$(MWOS_OSDIR)/68040/CMDS

MWOS_DDIR		=	$(MWOS)/SRC/DEFS
MWOS_CDEF		=	$(TOOLSET)/SRC/DEFS

MWOS_DFTDEF		=	$(MWOS_OSDIR)/68040/DEFS
...
MWOS_LIBDIR		=	$(MWOS_OSDIR)/68040/LIB     # Processor specific LIBs
