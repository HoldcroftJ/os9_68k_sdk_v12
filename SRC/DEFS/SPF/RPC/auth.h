 ...
 *  03 09/01/99 Added definitions for C++ usage.                       djl
 *  04 05/03/00 Added support for threads                              rds
 ****************************************************************************/
...
*/
struct opaque_auth *_rpc_getnullauth(void);
#define _null_auth (*(struct opaque_auth *)_rpc_getnullauth())
 ...
 *	int *aup_gids;
 */
AUTH *authunix_create(char *machname, int uid, int gid, int len,
																int *aup_gids);
