...
# 02 98/10/27 CODO-ized makefile                                      ajk   #
#             $$                    <RELEASE_INFO>                     $$   #
#############################################################################
# I-code specific portion of FLSHCACH ROM P2 Makefile                       #
#############################################################################
#                                                                           #


$(ODIR)/flush68k:	$(P2_START) $(CICODE) $(P2_ILIBN) $(OSK_ROMLIB)/flushcache.l
	$(CODO) $(ODIR)/flush68k
	-$(DEL) $(ODIR)/flush68k
	...
	$(ILINK) -l=$(OSK_ROMLIB)/flushcache.l $(P2_START) $(CICODE) \
			-fd=$(ODIR)/flush68k -ols=$(ODIR)/STB/flush68k.map

$(ODIR)/flush349:	$(P2_START) $(CICODE) $(P2_ILIBN) $(OSK_ROMLIB)/flush349.l
	$(CODO) $(ODIR)/flush349
	-$(DEL) $(ODIR)/flush349
	...
	$(ILINK) -l=$(OSK_ROMLIB)/flush349.l $(P2_START) $(CICODE) \
			-fd=$(ODIR)/flush349 -ols=$(ODIR)/STB/flush349.map

$(ODIR)/flushnom:	$(P2_START) $(IDIR)/flushnom.i $(P2_ILIBN)
	$(CODO) $(ODIR)/flushnom
	-$(DEL) $(ODIR)/flushnom
	...
	$(ILINK) $(P2_START) $(IDIR)/flushnom.i \
			-fd=$(ODIR)/flushnom -ols=$(ODIR)/STB/flushnom.map

$(ODIR)/$(OBJS):	$(P2_START) $(CICODE) $(P2_ILIBN)
	$(CODO) $(ODIR)/$(OBJS)
	-$(DEL) $(ODIR)/$(OBJS)
	...
	$(ILINK) $(P2_START) $(CICODE) \
			-fd=$(ODIR)/$(OBJS) -ols=$(ODIR)/STB/$(OBJS).map
