...
#ifdef raw0
/***************************************************************************/
/****               Device Descriptor for SPF spraw driver              ****/
/****                                                                   ****/
/****    This section contains the configurable parameters for spraw    ****/
/***************************************************************************/

/*
** The spraw driver will buffer this much incoming data before it starts
...
** to 256K.
*/
#define RECVBUFFER 0x2000

/*
** This value controls the maximum amount of data that can be sent in a
** single datagram. This may also be set on a per socket basis using
...
*/
#define SENDBUFFER 0x2000

/*
** This value is only used if a protocol is pushed on top of spraw.
**
** SPF will initiate flow control on a path when its read queue exceeds
** this threshold. Once flow control is enabled spraw will buffer data
** up to the paths RECVBUFFER size. When the application reads data
** and the queue falls below this value all buffered data in spraw is
** delivered to SPF.
*/
#define READSZ 4096
/***************************************************************************/
