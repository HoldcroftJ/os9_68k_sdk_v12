...
#  04 06/15/99 Added CODO for dbg's                                   rds
############################################################################
...
ODIR		=	$(MWOS_ODIR)/BOOTOBJS/SPF/MON
DRDIR		=	$(MWOS)/SRC/DPIO/SPF/DRVR
SDIR		=	$(DRDIR)/$(SUBDIR)

#
# The driver uses the value of the DEBUG macro to determine how big to make
# the debug data module.
#
DEBUG		=	-dDEBUG=0x2000 -l=$(MWOS_DFTLIB)/dbg_mod.l

DEFINES		=	

RDIR		=	RELS/SPDBG/$(MWOS_LDIR)
IDIR		=	$(RDIR)
