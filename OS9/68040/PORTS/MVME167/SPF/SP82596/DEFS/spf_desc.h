 ...
 *     10/26/98 changed TXSIZE from 1024 to 1500 and lu_ncbl in    mgh      *
 *                SP82596/defs.h  to improve performance                    *
 ****************************************************************************/
...
#define VECTOR		0x67		/* Port vector 				*/
...
#define DRV_NAME    "sp167"     /* device driver name           */
