 opt -l
*
* System Definitions for MVME167 System
*
********************
* Edition History
*   date    comments                                            by
* -------- ---------------------------------------------------- ---
* 91/03/26 preliminary information used to devise this approx.  Rwb
* 91/08/07 changed various defs for cobbled startup version.    wwb
* 91/08/27 revised vector defs and RTC base address             Rwb
* 91/09/09 revised vector defs for CD2401 (each port unique.)   Rwb
* 91/10/07 revised vector defs for PCC (problem with printer)   Rwb
* 91/10/08 general revisions to default defs per final sysinit. wwb
* 91/10/15 added GCSRBase definition.                           wwb
* 91/10/22 removed (most of) testing stuff.                     wwb
* 91/11/05 cleanup pass for release.                            wwb
* 91/11/22 added CacheList entries.                             wwb
*          <<<---- VME167 V2.4 Release ---->>>
* 91/12/18 added fpu module to Extens list.                     wwb
* 92/08/06 added INHOUSE conditionals for:                      wwb
*           - all memory mapped >0x80000000
*          [NOTE: ticker not @ 100/sec will be turned on later
*                 using FASTTICK conditional]
* 92/11/18 removed last changes for present.					wwb
* 93/07/08 Started rework for MWOS structure.					ats
* 93/07/28 Adapt new NVRAM construct.                           ats
* 93/08/27 Added MCECC definitions.                             ats
*          Added fpu to init extensions list.
* 93/09/14 Folded in Warren's reworked tape descriptors.        ats
* 93/09/16 Reorganized special search list.						ats
*          Don't map out first $100 bytes for buddy alocator.
*          Increase maximum memory to 64MB.
* 93/11/09 Adopt RAMLOAD flags instead of BPLOAD.				ats
...
* 99/05/13 changed to 1meg spl search area to accomdate larger  lrh
...
* 99/07/18 Added config to set System state caching to copyback mgh
*

********************
* Conditional Assembly Variables
*
VME167 equ 167 default value for VME167
...
* (as defined/used by Motorola 167 debugger)
*
...
CPUType  set VME167 define the cpu module in use
...
PCCTK2Level equ 6 PCC Timer 2 -- Used as the System Tick (tk167)
...
PCCTK2Vect equ PCCVectBase+$8 PCC Timer 2 -- Used as the System Tick (tk167)
...
CONFIG macro
MainFram dc.b "Motorola VME167",0
...
ClockNm dc.b "tk167",0 clock module name

*  NOTE that "snooper" module must appear before "syscache" module
*
* include mmu, snooping, caching.
Extens dc.b "OS9P2 snoop167 syscache ssm fpsp fpu sysmbuf OS9P3",0
...
TERM macro
 ifdef FASTCONS
 SCFDesc TermBase,TermVect,TermLev,5,$00,$0f,sc167
 else
 SCFDesc TermBase,TermVect,TermLev,5,$00,$0e,sc167
 endc 
...
T1 macro
 ifdef FASTCOMM
 SCFDesc T1Base,T1Vect,T1Level,5,$00,$0f,sc167
 else
 SCFDesc T1Base,T1Vect,T1Level,5,$00,$0e,sc167
 endc
DevCon dc.b CD2401_0
 endm

P1 macro
 SCFDesc P1Base,P1Vect,P1Level,5,$00,$0e,sc167
Mode set Share_+ISize_+Write_
DevCon dc.b CD2401_0
 endm

T2 macro
 SCFDesc T2Base,T2Vect,T2Level,5,$00,$0e,sc167
DevCon dc.b CD2401_0
 endm

P2 macro
 SCFDesc P2Base,P2Vect,P3Level,5,$00,$0e,sc167
Mode set Share_+ISize_+Write_
DevCon dc.b CD2401_0
 endm

T3 macro
 SCFDesc T3Base,T3Vect,T3Level,5,$00,$0e,sc167
DevCon dc.b CD2401_0
 endm

P3 macro
 SCFDesc P3Base,P3Vect,P3Level,5,$00,$0e,sc167
Mode set Share_+ISize_+Write_
DevCon dc.b CD2401_0
 endm
...
P macro
 SCFDesc PRNTBase,PPACKVect,PPACKLevel,5,$00,$00,scp167
Mode set Share_+ISize_+Write_
DevCon set 0
 endm
 pag
...
DevCon dc.b "scsi167",0 low-level driver module
 endm
