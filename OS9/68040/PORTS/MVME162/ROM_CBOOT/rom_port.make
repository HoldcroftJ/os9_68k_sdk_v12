# Makefile for port modules in the MVME162 ROM
-bo
-x
-mode=compat
...
CSRCHDIRS	= -v=. -v=.. -v=$(VME050DEFS) -v=$(BOOTDEFS) -v=$(SCSICDEFS) \
				-v=$(SCSIDEFS) -v=$(SBTRDEFS) -v=$(SYSDEFS) -v=$(CDEFS) 
CFLAGS		= -mode=compat -qst=$(TMPDIR) -O=0 -dCBOOT -dVME162 $(SPEC_CFLAGS) $(CSRCHDIRS)
