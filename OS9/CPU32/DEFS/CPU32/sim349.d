 opt -l
 nam sim349.d
 ttl Definitions for the mc68349 SIM (Systems Integration Module)

**********************************************************************
* Definitions for the mc68349 SIM (Systems Integration Module)
*
* Edition History
*
* Ed.   Date.     Reason.										Who.
* --  --------  -----------------------------------------------	---
* 01  93/09/15	created from simm340.d							wwb
...
********************************************************************
*  These are the mc68349 SIM common registers.  These are used to set up
...
BMT512 equ 0  512 system clocks
BMT256 equ 1  256 system clocks
BMT128 equ 2  128 system clocks
BMT64  equ 3   64 system clocks
...
SYNX   equ $4000 Frequency control bit [prescaler, speed x2]
SYNY   equ $3F00 modulus down counter value
SYNZ   equ $0080 Frequency control bit [divide by 8 if set]
...
b_BAREDS  equ 2  Extended delay select (used with DD1/2)
...
BAREDS    equ  1 If set (b_BAREDS) then delay encoded along with DD1/DD2.
