...
int getbootmethod()
{
	...
	bdrivers_qty = 3;		    /* number of boot drivers */
	...
	if (sys_switches & MENUSWITCH){
		iniz_boot_driver(bootqe,"Quads Ethernet Boot","Boot from Ethernet","qe");
...
{
	return E_UNKSVC;	/* unused in this implimentation (just in case..) */
}
