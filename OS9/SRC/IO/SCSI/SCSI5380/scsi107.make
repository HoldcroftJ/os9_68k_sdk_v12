...
ODIR		= $(CPUROOT)/PORTS/MVME$(MACHINE)/CMDS/BOOTOBJS
...
#CFLAGS		= -qst=$(TMPDIR) -O=0 $(SRCHDIRS) -dVME$(MACHINE)
CFLAGS		= -to=osk $(SRCHDIRS) -dVME$(MACHINE) -dOSK -r -td=$(TEMP)
...
exec.r : exec.c $(DEFS) $(SDIR)/io_poll.c $(MAKER)
