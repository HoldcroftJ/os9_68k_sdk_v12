...
ODIR		= $(CPUROOT)/PORTS/PCB$(MACHINE)/CMDS/BOOTOBJS
...
-mode=ucc
#CFLAGS		= -qst=$(TMPDIR) -O=0 $(SRCHDIRS) -dUSEDMA -dPCB$(MACHINE)
CFLAGS		= $(SRCHDIRS) -dUSEDMA -dPCB$(MACHINE) -dOSK -r -td=$(TEMP)
...
exec.r : exec.c $(DEFS) $(SDIR)/io_1782.c $(MAKER)
