/*
 * support.c - NCR 53C710 SIOP and Motorola mVme172 specific subroutines.
 */
 
/*
 * Copyright 1991, 1994, 1995-1997 by Microware Systems Corporation
...
#endif
{
	...
	return( (u_int8) ((mcc->V4_NOLC) ? (30*2) : (32*2)));
}
 ...
 *  mVme172 this is done via an ASIC (MCC).  Action points:
 ...
 *
 *  Port Notes:
 *		The mVme172 offers status of the bus latched into the MCchip
