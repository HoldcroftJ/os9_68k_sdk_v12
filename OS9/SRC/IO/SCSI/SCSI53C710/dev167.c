/*
 * support.c - NCR 53C710 SIOP and Motorola mVme167 specific subroutines.
 */
...
#endif
{
	 volatile u_int8 *MemC40speed = (u_int8 *)MEMC40BCR;
	
	return( (u_int8)(*MemC40speed) * 2);
}
 ...
 *  mVme167 this is done via an ASIC (PCC2).  Action points:
 ...
 *
 *  Port Notes:
 *		The mVme167 offers status of the bus latched into the PCC2 chip
...
#endif
{
	...
	Lthread lth;
	Siop_p const siop =  (Siop_p) lst->hdware;	/* adddres of the 53c710 */
#ifndef CBOOT
	extern void _timer();
#endif		
