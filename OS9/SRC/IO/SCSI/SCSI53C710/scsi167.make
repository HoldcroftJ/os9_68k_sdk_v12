...
#
# Low-Level Subroutine for SCSI Interface on Motorola mVme167 SBC
...
MACHINE		= 167
CPUDIR		= 68040							# Look for CPU Specific items
...
#		-dERRATA040 enables code that circumvents 68040 bug (dev16x.c)
...
PFLAGS		= -dVME$(MACHINE) -dERRATA040 $(SCLK) \
...
-mode=ucc
CFLAGS		= -o=7 -x=ao -a -r -to=osk -tp=040 -td=$(TMPDIR) \
