...
# High-Level Driver for Exabyte 8200 Drive [VARIABLE BLOCK VERSION]
#
...
OBJ			= sb8200					# the high-level driver name
...
CFLAGS		= -qst=$(TMPDIR) -O=2 $(SRCHDIRS) $(DEBUG) -dEXABYTE -dVARBLK
