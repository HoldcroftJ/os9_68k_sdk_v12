/*--------------------------------------------------------------------------!
! bp_timer.c: timer routines for BOOTP code: VME162							!
+---------------------------------------------------------------------------+
!	Edition History:														!
!	#   Date    Comments												By	!
!	-- -------- ------------------------------------------------------- ---	!
!	01 93/01/27 Adapted from VME167										ats	!
!   02 93/06/10 "Ultrified"                                             bat !
!	03 93/08/27 inetboot.h deleted. replaced by corr. includes			gkm !
!               ---- OS-9 V3.0 Released ----                                !
!   04 98/01/29 moved declaration for bpt_test to inetboot.c            mgh !
...
#define T_VECT		0x58		/* assumes MCchip base irq=0x50 */
...
{
	/*----------------------------------------------------------!
	! The MCchip Timers rattle away at 1uS increments, thus you	!
	...
	/* setup Timer #2 in MCchip */
	*((char *)T_CTRL) = 0;			/* MCchip: clear all status/irq enables */
