# Makefile for the MVME147 SCF Descriptors
...
# serial ports
#
SCFDSC		= term   t1   t2   t3   p1   p2   p3   p
SCFDSCR		= term.r t1.r t2.r t3.r p1.r p2.r p3.r p.r
...
# Link everything
#
scf_descriptors _build: makdir $(SCFDSC)
	$(COMMENT)
