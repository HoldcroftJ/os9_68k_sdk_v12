 opt -l
*
* System Definitions for MVME172 System
*
********************
* Edition History
*   date    comments                                            by
...
* 97/03/25 adapted from mvme162 version.                        gdw
* 98/01/26 added support for fpu.                               gdw
* 98/02/18 Added NoSnoop060 define.                             gdw
* 99/07/12 changed to 1meg spl search area to accomdate larger  mgh
...
*          Set rom search area at 32k for each rom location.
* 99/07/19 Add commented location to change system state cache mgh
* 01/02/23 Add Flash Disk Macro (based on MVME162)             mdu
*
...
*	If coldstarting 172Bug from FLASH, the address spaces are swapped.
...
SRAMBugSize equ $10000 Saving 64K for the 172Bug space.
...
* (as defined/used by Motorola 167/162/172 debugger)
*
...
CPUType  set VME172 define the cpu module in use
...
* timer if tk172.a is built with -aTKVME.
*
****************************************
...
MainFram dc.b "Motorola VME172",0
 ifdef DEVTAPE
...
ClockNm dc.b "tk172",0 clock module name

*  NOTE that "snooper" module must appear before "syscache" module
*
Extens dc.b "OS9P2 snoop172 syscache ssm" include snooping, cacheing, mmu
 ifdef	HARDFPU
  dc.b " fpsp" include unimplemented fp instructions
 else
  dc.b " fpu" include fp instructions, spsp is faster on a full 060
 endc
  dc.b " intsp" include unimplemented integer instructions
...
TERM macro
 ifdef FASTCONS
 SCFDesc TermBase,TermVect,TermLev,5,$00,$0f,sc172
 else
 SCFDesc TermBase,TermVect,TermLev,5,$00,$0e,sc172
 endc 
DevCon dc.b 0
 endm
...
T1 macro
 ifdef FASTCOMM
 SCFDesc T1Base,T1Vect,T1Level,6,$00,$0f,sc172
 else
 SCFDesc T1Base,T1Vect,T1Level,6,$00,$0e,sc172
 endc
DevCon dc.b 0
 endm

T2 macro
 SCFDesc T2Base,T2Vect,T2Level,7,$00,$0e,sc172
DevCon dc.b 0
 endm

T3 macro
 SCFDesc T3Base,T3Vect,T3Level,8,$00,$0e,sc172
DevCon dc.b 0
 endm

P1 macro
 SCFDesc P1Base,P1Vect,P1Level,6,$00,$0e,sc172
Mode set Share_+ISize_+Write_
DevCon dc.b 0
 endm

P2 macro
 SCFDesc P2Base,P2Vect,P2Level,7,$00,$0e,sc172
Mode set Share_+ISize_+Write_
DevCon dc.b 0
 endm

P3 macro
 SCFDesc P3Base,P3Vect,P3Level,8,$00,$0e,sc172
Mode set Share_+ISize_+Write_
DevCon dc.b 0
 endm
...
DevCon dc.b "scsi172",0 low-level driver module
 endm
...
* of the Flash Disk.
*
* The reason we only use 1MB of Flash Disk is that the first 1MB of
* the whole Flash is used to store the OS-9 Coreboot, and leave the rest
* of the Flash to make a Flash Disk
*
* If you want more/less Flash Disk space, just adjust the
* FlashDSize values below
 
FlashDBase      equ $FFA00000   Base address of FLASH Disk
FlashDSize	equ $200000	Size of FLASH Disk - 2MB
