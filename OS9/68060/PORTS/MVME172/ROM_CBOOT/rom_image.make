# Makefile for linked rom image in the MVME172 ROM
-mode=compat
-bo
-x
-B
...
LLSCSI		= $(BOOTROOT)/bt_172_53c710.l
HLS_HD		= $(BOOTROOT)/bootsccs.l
HLS_FD		= $(BOOTROOT)/bootfc1.l
HLS_TP		= $(BOOTROOT)/bootviper.l
ALLSCSI		= $(LLSCSI) $(HLS_HD) $(HLS_FD) $(HLS_TP)

TKETH		= $(BOOTROOT)/bp_tk172.l
LLETH		= $(BOOTROOT)/bp_172_82596.l
BPETH		= #$(BOOTROOT)/bp_172_bp.l      # was bp_167bp.l
...
LC			= l68
LFLAGS		= -r=FF800000 -swam -M=3k -g -b=4 $(LIBS)
