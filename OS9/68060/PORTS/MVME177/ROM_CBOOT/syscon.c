/*--------------------------------------------------------------------------!
! syscon.c: System specific boot configuration routines for the VME177		!
+---------------------------------------------------------------------------+
!	Edition History:														!
!	#   Date    Comments												By	!
!	-- -------- ------------------------------------------------------- ---	!
...
!	10 94/04/19 Started mods for MVME177.								wwb	!
!               ---- OS-9/68K V3.0.2 Beta release ----						!
!               ---- OS-9/68K V3.0.2 Release ----							!
!   11 99/03/29 Change location for systype.h                           mgh !
!---------------------------------------------------------------------------!
!                                                                           !
...
/*
 *  nvrw - routine to read and write the NVRAM for the mVme177 card.
 *
